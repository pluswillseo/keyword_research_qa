...
selected_categories = st.selectbox('Filter out misspellings/special characters', ["", "Potential misspelling or error"])
...
duplicate_s = st.selectbox('Filter out non s duplicates with same search volume', ['true','false'])
